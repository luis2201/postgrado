<?php
    ...
    class Maestria extends DB
    {
        ...
        public static function findEstudiantesMaestriaID($params)
        {
            ...
            $prepare = $db->prepare("SELECT E.NumeroIdentificacion, CONCAT(E.Apellido1, ' ', E.Apellido2)AS Apellidos, CONCAT(E.Nombre1, ' ', E.Nombre2)AS Nombres, E.Correo, E.Telefono
                                     FROM Matricula M 
