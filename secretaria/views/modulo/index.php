...
<div class="card">
    ...
    <div class="card-body p-3">
        <form class ="needs-validation" action="<?php echo DIR; ?>modulo/findmodulosmaestriaid" method="post" data-action="select" enctype="multipart/form-data" autocomplete="off" novalidate>
            <div class="row">
                <div class="col-2">
...
<div class="card mt-2 mb-4">
    <div class="card-header">
        ...
        Lista de Módulos por Oferta Académica
        <a class="btn btn-success btn-sm float-end" href="modulo/agregar"><i class="fa-solid fa-circle-plus"></i> Agregar Módulo</a>
    </div>
